...
function test_theme_scripts() {
	...
	wp_enqueue_script( 'test-theme-bootstrap.min', get_template_directory_uri() . '/assets/js/bootstrap.min.js', array(), _S_VERSION, true );
	wp_enqueue_script( 'test-theme-jQuery', get_template_directory_uri() . '/assets/js/jQuery.js', array(), _S_VERSION, true );
